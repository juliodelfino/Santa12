		...
		dropdown
			.css({
				left: dropdown.hasClass('anchor-right') ? 
					trigger.offset().left - (dropdown.outerWidth() - trigger.outerWidth() - 50) : trigger.offset().left,
				top: (dropdown.css('position') == 'fixed' ? 15 : trigger.offset().top) + trigger.outerHeight()
			})
			.show();
